...
;최초작성일: 2023년 6월 17일
;수정일: 2023년 10월 3일
;유튜브 촬영을 위한 코드 재배열 완료
;버젼정보: Beta 5.81
;-----------------------------------------------------


Global ThisWindowTitle := "H 매크로"
...
;사용된 옵션들
CheckBoxList := ["자동재접속사용여부","힐링포션사용여부", "HP마을귀환사용여부", "리메듐사용여부", "마나포션사용여부", "MP마을귀환사용여부", "브렐사용여부", "식빵사용여부", "식빵구매여부", "골드바판매여부", "골드바구매여부", "대화사용", "명상사용", "더블어택사용", "체력향상사용", "민첩향상사용", "활방어사용", "마력향상사용", "마법방어향상사용", "3번", "4번", "5번", "6번", "7번", "8번", "은행넣기활성화", "소각활성화","아템먹기여부","자동이동여부", "훔치기사용", "훔쳐보기사용", "Sense사용", "자동사냥여부", "무기사용여부","특오자동교환여부","행깃구매여부","라깃구매여부","독침사용","현혹사용","폭검사용","무기공격사용","집중사용","회피사용","몸통찌르기사용","리메듐사용","라리메듐사용","엘리메듐사용","쿠로사용","빛의갑옷사용","공포보호사용","다라사용","브렐사용","브레마사용","물의갑옷사용","감속사용","마스사용","라크사용","번개사용","브리스사용","파스티사용","슈키사용","클리드사용","스톤스킨사용","파라스사용","베네피쿠스사용","저주사용","자동파티여부", "포레스트네자동대화","RemoveArmor사용","좀비몹감지", "위치고정", "배경제거", "캐릭제거"]
SpellList := ["리메듐","라리메듐","엘리메듐","쿠로","빛의갑옷","공포보호","다라","브렐","브레마","물의갑옷","감속","마스","라크","번개","브리스","파스티","슈키","클리드","스톤스킨","파라스","베네피쿠스","저주"]
DropDownList := ["메인캐릭터서버", "메인캐릭터순서", "힐링포션사용단축키", "마나포션사용단축키", "식빵사용단축키", "식빵구매마을" ,"지침서", "오란의깃사용단축키", "포레스트네자동대화딜레이"]
EditList := ["힐링포션사용제한", "HP마을귀환사용제한", "MP마을귀환사용제한", "리메듐사용제한", "마나포션사용제한", "브렐사용제한", "식빵사용제한", "MP마을귀환사용여부", "넣을아이템","Multiplyer","NPC_MSG_ADR" ,"마지막사냥장소", "수련용길탐색딜레이", "NPC대화딜레이", "MoveSpeed", "게임배속","무기교체딜레이","현재모드"]
...
Global IsMoving := 0
RadioButton := ["주먹", "일무기", "일벗무바", "이무기", "이벗무바", "삼무기", "삼벗무바", "퍼펙트", "일반", "미스"]
...
/*
	이트 := 131
*/
게임내NPC들 := ["대장로","성향안내","장로","모험가","초보모험가","요리사","초보요리사","사냥꾼","초보무도가","세크티","콥","미너터","카리스","행운장","길드기","길드예선전보로1","길드예선전보로2","길드예선전보로3","길드예선전보로4","길드예선전보로5","길드예선전보로6","길드예선전보로7","길드예선전보로8","우물지기","우물지킴이","파미","실루엣","케이","휴","에레노아","길드만들기","라드","예절보로","할아버지","레나","초브","칼라스","브라키의여전사","테레즈","루비","오크왕자","슈","카딜라","나무보로","이사크","미소니","성궁사","수련장","그레파","미용바니","티포네","홀리","올드스미스","테디","피니","큐트","키드니","스텔라","실비아","네루아","사라","오블로","메티니","무타이","성검사","커스피스","쿠니퍼","라체","지올라","플린","헬러","브레너","에드가","두갈","아이렌","케드마","제프","젠","소니아","아바","네시아","래리","마리오","빈","렉스","다바트","코바니","플라노","미너스","토리온","브로이","카멘","카로에","시상보로","견습미용사","하즈","할머니","미스토","브라키의여전사","그라치","드리트","레시트","로크","메크","스타시","스테티나","이스카","호디니","베니","은행가드","파이","샤네트","코페","아일리아","퀘이드","레야","싱","유키오","이시","앨리아","오바","테론","윌라","페툴라","스티븐","우리안","빅터","리프","미네티","피트","비엔","칸느","포럼","콘스티","다인","티셔","백작","보초병","우트","랜스","뮤즈","리어","리즈","브라키의여전사","에스피","코니","스투","라니체","드류","체드","체스터","케인","울드","티모시","포츠","마카","미카","경비병","니키","수라","카르고","엘피","쿠퍼","페니","터크","베이","나크레토","로비어","앤타이","셀포이","비바","마데이아","가토고","엑소포","토이슨","코메이오","저주받은엘프","야노모이","오이피노","카레푸","엠토포","아이보","마나오","클레오","파노아","타키아","카오네자","나노아","미노스","세니코","주사위소녀1","주사위소녀1","주사위소녀2","주사위소녀3","주사위소녀4","주사위소녀5","주사위소녀6","주사위소녀7","주사위소녀8","주사위소녀9","주사위소녀10","주사위","주사위지배인","리노스","투페","히포프","베스","쿠키","소피","포프리아","나무꾼","레아","키아","세르니오","코르티","베커","포비","크로리스","길잃은수색대","동쪽파수꾼","서쪽파수꾼","리노아","펫조련사","게시판"]
로랜시아간판 := [111,608,610,612,614,618,620,622,624,626,630,632,634,636,638,640,642,644,646,648,650]
;["음악당","도서관","마법상점","잡화상점","무기상점","펍","우체국","대장간","은행","보석상점","교환장","병원","석공소","수련장소","여관","편집국","피니의옷가게","갑옷상점","베이커리","고깃상점","목공소","레나의무기점","게시판","길드기"]

이름이바뀌는존재들 := [21,751,753,552,554,560,558,556,496]
;이름바꿔지는존재들 혹은 애완동물
;수련인형(일랜기본) = 21
;클로버 751
;팬덕 753
...
;{ ; 메모리 쓰기/실행하기 함수
	...
	WriteExecutableMemory(코드) ; 미리지정된 코드를 호출하면 입력하고 실행가능하도록 권한설정변경
	{
		...
		Addrs := 0x005FB740
		RegionSize := 0x500
		target = 
		executable := mem.executable(Addrs, RegionSize)
		/*
		FlyHigh 님 블로그에서 배포중인 메모리무바 기반;
		단, 배포중인 무바는 1ms 마다 메모리를 읽어오기 때문에 매우 비효율적이고, 메모리 점유율이 너무 높아짐
...
;{ ; 설정 저장 및 불러오기 함수
	Setting_RECORD(type,itemname*) ; 캐릭별 ListView 값을 (별도) 폴더에 저장하기
	{
		...
		found := False
		Last := 0
IniRead, line, data, 맵번호7, 1
		; 각 이름에 대한 데이터를 확인합니다.
		for index, coord in itemList
		{
			Last := A_Index
			if (type = "좌표리스트" || tpye = "NPC리스트")
			{
				IniRead, existingData, %FileName%, %맵번호%, %A_index%
			}
			else if (type = "NEWDB" || type =  "MonsterList")
			{
			...
			else if (fields[1] = itemname[1] && type != "NPC리스트" && type != "NEWDB" && type != "MonsterList")
			{
				found := True
				break
			}
		...
		if (!found)
		{
			;SB_SetText(type "의" Last "줄에"  itemname "추가",2)
			if (type = "좌표리스트")
			{
			...
			else if (type = "NPC리스트")
			{
				...
				;URL := "https://script.google.com/macros/s/AKfycbzKYTxOhACubAbI7DjNLssaZOyo3nlJSxx_MUJ4Yshq/dev"
	...
	if (Ras_step = 1)
	{
		...
		if (IsMoving = 0)
		{
			if (맵번호 = 2)
				...
				좌표입력(135,119,1)
			마지막메모리실행시간확인 := A_TickCount - 마지막메모리실행시간
			if ( 마지막메모리실행시간확인 > 300 )
			{
				RunMemory("좌표이동")
				마지막메모리실행시간 := A_TickCount
			}
		}
	}
...
loop,
{
	...
	else if (repair_step = 2)
	{
		...
		;	KeyClick("AltR")
			...
			이번무기수리필요 := 0
			삼번무기수리필요 := 0
			guicontrol,,일번무기수리필요,%일번무기수리필요%
			guicontrol,,이번무기수리필요,%이번무기수리필요%
			guicontrol,,삼번무기수리필요,%삼번무기수리필요%
			loop, 4
			{
				if (Check_Shop("Repair") != 0)
				{
	...
	else if (맵번호 = 2 || 맵번호 = 1002 || 맵번호 = 2002 || 맵번호 = 3002 || 맵번호 = 4002) && (repair_step = 3)
	{
		break
	}

	else if (repair_step = 3)
	{
		gosub, 기본정보읽기
		gui,submit,nohide
...
원격파티하기: ;서포터용
{
	...
	loop, 10
	{
		if( %A_Index%번캐릭터사용여부 = 1)
		{
			...
			if (Target_P_OID != 0) && (파티타겟이름!="" && 파티타겟이름!=0)
			{
				found := True
				SetFormat, Integer, H
			...
			if (found = False) && (파티타겟이름!="" && 파티타겟이름!=0)
			{
				...
				loop % LV_GetCount()
				{
					LV_GetText(원격파티대상이름,임시번호,5)
					LV_GetText(원격파티대상OID,임시번호,6)
					if (원격파티대상이름 = 파티타겟이름)
					{
						SetFormat, Integer, H
...
else if (맵번호 = 4003)
{
	...
	loop, 5
	{
		...
		else if(formnumber = 77) || ifinstring, NPCMsg,이런 곳
		{
			mem.writeString(Result_Msg_Addr, "", "UTF-16", aOffsets*)
			break
		}
...
urldownloadtofile, https://raw.githubusercontent.com/Muaho7777/elancia/main-5/elancia gay, %temp_저장위치%
gui, listview, NPC리스트
...
if (I_Delay > 1000)
{
	...
	loop, 50
	{
		...
		LV_add("",A_Index,invenitem,ItemCount)
...
;{
	...
	if (식빵사용여부 = 1 && 식빵사용제한 > 현재FP && 최대FP !="" && 식빵사용카운트 < 5 )
	{
		SB_SETtext("식빵사용" ,3)
		if (현재FP기록 = 현재FP)
		{
	...
	else if (식빵사용카운트 >= 5 && 식빵사용제한 > 현재FP && 식빵구매여부 = 1)
	{
		keyclick(식빵사용단축키)
		SB_SETtext("식빵사용실패"식빵사용카운트 ,1)
...
Gui, Add, CheckBox, x375 y220 v좀비몹감지, 버스기사모드
...
coord_x := 15 + 82 * 2
Gui, Add, GroupBox, x%coord_x% y275 w77 h145,마하
coord_x := 25 + 82 * 2
...
coord_x := 15 + 82 * 5 - 5 * 2
Gui, Add, GroupBox, x%coord_x% y275 w77 h145,테스
coord_x := 25 + 82 * 5  - 5 * 2
...
gui, tab, 4
Gui, Add, Text, x15 y45 h15 w80, 좌표리스트
Gui, Add, button, x370 y40 w80 h20 g좌표리스트추가 , 좌표추가
Gui, Add, ListView, x15 y65 h335 w465 v좌표리스트 g좌표리스트실행 +altsubmit, 번호|순번|맵이름|X|Y|Z
LV_ModifyCol(1,50)
LV_ModifyCol(2,50)
LV_ModifyCol(3,200)
LV_ModifyCol(4,40)
...
x_coord := x_coord + 90
Gui, Add, button, x%x_coord% y%y_coord% w80 h20 g무바, 무바
x_coord := x_coord + 90
Gui, Add, button, x%x_coord% y%y_coord% w80 h20 g스킬사용하기, 스킬
x_coord := x_coord + 90
Gui, Add, button, x%x_coord% y%y_coord% w80 h20 g파라스해감,파라스해감
...
Gui, Add, text, x125 y330 w100 h20 v영번어빌이름, 영번어빌이름
Gui, Add, text, x125 y350 w100 h20 v일번어빌이름, 일번어빌이름
Gui, Add, text, x125 y370 w100 h20 v이번어빌이름, 이번어빌이름
Gui, Add, text, x125 y390 w100 h20 v삼번어빌이름, 삼번어빌이름
...
Gui, Add, text, x280 y270 w100 h20, 일번무기수리필요
Gui, Add, text, x280 y290 w100 h20, 이번무기수리필요
Gui, Add, text, x280 y310 w100 h20, 삼번무기수리필요
...
Gui, Add, EDIT, x395 y270 w70 h20 v일번무기수리필요,
Gui, Add, EDIT, x395 y290 w70 h20 v이번무기수리필요,
Gui, Add, EDIT, x395 y310 w70 h20 v삼번무기수리필요,
Gui, Add, EDIT, x395 y330 w70 h20 vURL,
Gui, Add, EDIT, x395 y350 w70 h20 v현재모드,
...
Y_coord += 20
Gui, Add, Text, x%x_coord% y%y_coord% w100 h20 ,원거리타겟OID
Y_coord += 20
Gui, Add, Edit, x%x_coord% y%y_coord% w100 h20 v특수원거리타겟OID,0x0
Y_coord += 20
Gui, Add, Text, x%x_coord% y%y_coord% w100 h20 ,근거리타겟OID
Y_coord += 20
Gui, Add, Edit, x%x_coord% y%y_coord% w100 h20 v근거리타겟OID,0x0
Y_coord += 20
Gui, Add, Text, x%x_coord% y%y_coord% w100 h20 ,사용된스킬개수기록
Y_coord += 20
Gui, Add, Edit, x%x_coord% y%y_coord% w100 h20 v사용된스킬개수기록,0
		...
		if (서버상태)
		{
			loop,
			{
				...
				if (서버상태) ;만약 서버접속중이 확인되면 현재 모드를 확인
				{
					...
					else if (현재모드 = "단순제작") ;만약 "단순제작" 모드라면
					{
						loop,
						{
							if (현재모드 = "단순제작") && (서버상태)
							...
							if (현재모드 = "광물캐기") && (서버상태)
							{
								...
								if ( 자사_현재선택 != 0 )
								{
									...
									else ; 그 선택된 몬스터가 새로운 몬스터가 아니라면 ;블랙리스트에 등록할지 말지 결정
									{
										...
										else if (좌표X = 시작X && 좌표Y = 시작Y) ;만약 2초간 몬스터와 거리 1 초과에 멈춰서있다면
										{
					...
					else if (현재모드 = "일반자사" || 현재모드 = "포남자사" || 현재모드 = "포북자사") ;만약 "포남자사" 모드라면
					{
						loop,
						{
							if (현재모드 = "일반자사") && (서버상태)
							...
							else if (현재모드 = "포남자사") && (서버상태)
							{
								...
								if (라스의깃열려있는지확인() != 0)
								{
									SB_SETtext("ERROR-U-1",1)
									stopsign := True
									continue
								}

								if (인벤토리 > 0 && 인벤토리 < 50) || !(맵번호 != 2 && 맵번호 != 1002 && 맵번호 != 2002 && 맵번호 != 3002 && 맵번호 != 4002 )
								{
									인벤토리점검필요 := 0
								}
								else if (인벤토리 = 50)
								...
								;만약 "자사" 모드등 인연버그 또는 길드초대버그 등의 대상이 될 수 있는 상황이라면
									if !(NPC대화창사용중) && NPCMsg
										gosub, NPC대화창으로방해하는지확인
									;만약 직접 NPC대화를 사용중이 아니라면

										;모든 NPC 대화창 종료

									;맵번호를 확인하여 유효한 맵인지 확인
									맵유효성 := False
									sleep,1
									if ( 현재모드 = "포남자사")
									{
										;유효한맵 마을: 4002 포남: 4005
										if (맵번호 = 4002 || 맵번호 = 4005)
											맵유효성 := True
										sleep,1
									}
									sleep,1
									if !(맵유효성) ;유효한 맵이 아니라면 오란의깃 또는 라스의깃 사용을 통해서 유효한 맵으로 우선 이동
									{
										마을귀환성공여부 := False
										sleep,1
										guicontrol, ,마을귀환이유, 유효성검사실패
										sleep,1
										keyclick(오란의깃사용단축키)
										sleep,1
										SB_setText("무기수리필요",1)
									...
									sleep,1
									if (맵번호 = 2 || 맵번호 = 1002 || 맵번호 = 2002 || 맵번호 = 3002 || 맵번호 = 4002) ;만약 마을이라면
									{
										;스킬사용을 불가로 변경

											;그레이드 필요여부 확인하여 그레이드 진행

												;정령의보석 갯수가 10개 이하이면 그레이드 진행 취소

												;만약 갈리드가 100만 미만이면

													;골드바 판매 여부 확인

														;골드바 소지중이고 골드바 판매가 활성화 되있다면 골드바 판매 진행

														;골드바가 부족하면 진행 취소

													;만약 갈리드가 10만 미만이면 식빵구매 진행 취소

											;식빵구매 필요여부 확인하여 식빵구매 진행

												;만약 갈리드가 10만 미만이면, 식빵구매 진행 취소

											;무기수리 필요여부 확인하여 무기수리 진행

												;만약 갈리드가 10만 미만이면, 무기수리 진행 취소

											;라깃구매 필요여부 확인하여 라깃구매 진행

												;라깃구매가 필요한데 만약 갈리드가 10만 미만이면, 동작정지

										;모두 필요없다면 스킬사용을 가능으로 변경
									}
									sleep,1
									if ( 현재모드 = "포남자사" )
									{
										...
										;금일 링교환 헀는지 여부 확인
											...
											;만약 안했다면 NPC대화창 사용중으로 변경하고 리노아 메뉴 호출 링교환 진행

											;가루가 충분하면 교환 진행

											;교환 완료된 아이템과 시간을 기록하고 종료

										;만약 했다면 NPC대화창 사용중으로 변경하고 리노아 메뉴 호출 포남 입장

											;입장이 확인되면 NPC대화창 사용중 False
									}
									else if ( 현재모드 = "포북자사")
									{
											...
											;만약 사냥터라면
												...
												;그레이드, 식빵구매, 무기수리, 라깃구매가 필요하다면 오란의깃 사용하여 마을 귀환

												;주변 몬스터가 있다면 공격

													;몬스터와 거리 1 상태에 도달했는지 확인

														;움직이는 중이면 건너뛰기

														;움직이지 않는다면 클릭 한번 더해보고
													...
													;몬스터와 거리 1상태라면
														...
														;공격관련 어빌이 올랐는지 확인
															...
															loop,  ; 0.5초마다 결과 확인
															{
																...
																상승어빌값 := mem.read(상승어빌값주소, "UInt", aOffsets*)
																guicontrol, ,상승어빌, %상승어빌%
																if instr(상승어빌, "격투") || instr(상승어빌, "도") || instr(상승어빌, "검")
																{
																	상승어빌카운트 := mem.read(상승어빌카운트주소, "UShort", aOffsets*)
																	필요어빌카운트 := mem.read(필요어빌카운트주소, "UShort", aOffsets*)
																	if (기존어빌카운트 != 상승어빌카운트)
												...
												;만약 제한시간이 되었다면 동쪽파수꾼 호출

													;동쪽 파수꾼 OID가 있는지 확인

													;없다면 좌표이동 실시

												;만약 제한시간이 되었다면 서쪽파수꾼 호출
...
for index, result in MonsterList
{
	...
	if (addr != AddressToCheck ) || ((분류 != "몬스터") && (LV_Row > 0))
    {
	...
	if (kind = "알수없음")
	{
		...
		for index, PossibleKind in MonsterInfo
		{
			...
			if (findMID == fields[2])
			{
				if (종류 = "MonsterInfo") ;메모리 절약을 위해 몬스터DB가 있다면 몬스터DB로부터 읽어온다
				{
					kind := "몬스터"
					SB_SetText(find_name "를" 종류 "의" PossibleKind,5)
					break
				}
			}
		}
	...
	{
		gui, listview, %ListGUI%
		LV_Modify(LV_Row,"", kind, 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, resultHex, , distanceXYZ ,findMID)
		continue
	}
...
if ((LVSelect != 0) || (LVCount = 0))
{
	...
	if (IsDataInList(col5Value, WantedItems)|| WantedMonsterlength = "" || WantedMonsterlength < 1)
		return
	else
	{
		gui, listview, 몬스터리스트
...
/*
	...
	WantedItemlength := WantedItems.MaxIndex()
	WantedMonsterlength := WantedMonsters.MaxIndex()
	BlackedListlength := BlackedList.MaxIndex()
...
Loop, %LVCount%
{
    ...
    if (col12Value < lowestCol12Value && !IsDataInList(col6Value, BlackedList)) && (IsDataInList(col5Value, WantedMonsters) || WantedMonsterlength = "" || WantedMonsterlength < 1)
    {
...
for index, result in PlayerList
{
	...
	{
		gui, listview, %ListGUI%
		LV_Modify(LV_Row,"", kind, 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, resultHex, deletedelay1, distanceXYZ ,findMID)
		continue
	}

	gui, listview, %ListGUI%
	LV_Add("", kind, 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, resultHex, deletedelay1, distanceXYZ ,findMID)
}
return
;}
...
{
	LV_GetText(col5Value,LVSelect,5)
	if (IsDataInList(col5Value, WantedItems) || WantedItemlength = "" || WantedItemlength < 1)
		return
	else
	{
		gui, listview, 아이템리스트
...
Loop, %LVCount%
{
    ...
    ; Col12 값이 현재 가장 낮은 값보다 낮고, Col5 값이 WantedList에 포함되고, Col6 값이 BlackList에 없는 경우
    if (col11Value < 3 && col12Value < lowestCol12Value && !IsDataInList(col6Value, blackedList)) && (IsDataInList(col5Value, WantedItems) || WantedItemlength = "" || WantedItemlength < 1)
    {
        lowestCol12Value := col12Value
        selectedRow := thisRow
    }
...
for index, result in ItemList
{
	...
	if (find_z = 0)
	{
		...
		loop % LV_GetCount()
		{
			...
			{
				blackedlist.push(find_object_id)
				Lucky := False
				break
			}
		}
...
loop % LV_GetCount()
{
	...
	else if (거리X<16 && 거리Y<8 && 삭제딜레이 > 0)
	{
		LV_Modify(i,"Col11",삭제딜레이)
	}
	else if (거리X<16 && 거리Y<8 && 삭제딜레이 <= 0) || (아이템위치Z = 1)
	{
		AddressResult := mem.read(아이템주소, "UInt", aOffsets*)
		find_z := mem.read(아이템주소 + 0x14, "UInt", aOffsets*)
		if (AddressResult != AddressToCheck || find_z = 1 || 아이템위치Z = 1)
		{
			LV_Delete(i)
			keyclick("ALtR")
			continue
...
메모리_주변검색: ; 공유용: 과도한 CPU점유율에 대한 관찰
;{
메모리_주변검색상태RunCount++
...
;{ ;맵이 동일한지 확인; 만약 맵이 달라졌다면 모든 리스트를 초기화
	Gui, Submit, Nohide
	if (기존맵번호 != 맵번호 && 맵번호 != "" && 맵번호 != 0)
	{
		;SB_SETtext("기존맵번호" 기존맵번호 "현재맵번호" 맵번호 ,2)
...
for index, result in MonsterList
{
	...
	else
	{
		...
		gui,listview,몬스터리스트
		distanceX := Abs(find_x - 좌표X)
		distanceY := Abs(find_y - 좌표Y)
		distanceZ := Abs(find_z - 좌표Z)
		...
		kind := "알수없음"
		종류확인 := ["게임내고용상인들", "MonsterInfo", "게임내NPC들", "로랜시아간판", "이름이바뀌는존재들"]
		for index, 종류 in 종류확인
		{
			if (kind = "알수없음")
			{
				for index, PossibleSeller in %종류%
				{
					if (InStr(find_name, PossibleSeller))
					{
						if(종류 = "게임내고용상인들")
							kind := "고용상인"
						else if(종류 = "MonsterInfo") ;메모리 절약을 위해 몬스터DB가 있다면 몬스터DB로부터 읽어온다
							kind := "몬스터"
						else if(종류 = "게임내NPC들")
							kind := "NPC"
						else if(종류 = "로랜시아간판")
							kind := "간판"
						else if(종류 = "이름이바뀌는존재들")
							kind := "몰라"
						break
					}
				}
		...
		loop % LV_GetCount()
		{
			...
			if(기존_object_id = find_object_id)
			{
				...
				LV_Modify(A_Index, "", kind, 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, result, deletedelay1, distanceXYZ,findMID)
				IsNewOID := False
				break
			}
		}
		...
		{
			if (kind = "몬스터") || (맵번호 = 237 || 맵번호 = 1403 || 맵번호 = 2300 ||맵번호 = 3300 || 맵번호 =  3301 || 맵번호 = 201)
				LV_Add("", kind, 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, result, deletedelay1,distanceXYZ ,findMID)
			if (kind = "NPC") && !(find_name = "" || find_object_id = "")
			{
				Gui, ListView, NPC리스트
				Find := False
				loop, % LV_GetCount()
				{
					...
					LV_GetText(기존NPC이름,A_Index,5)
					LV_GetText(기존NPCOID,A_Index,6)
					if (기존NPC차원 = 차원 && 기존NPC이름 = find_name && 기존NPCOID = find_object_id )
					{
						Find := True
						break
					}
...
loop % LV_GetCount()
{
	...
	LV_GetText(기존_몬스터주소, temp_i, 10)
	업데이트_카운트 := 기존_카운트 - 1
	addr := mem.read(기존_몬스터주소, "UInt", aOffsets*)
	if (addr = 0x005420AC)
	{
		;SB_SetText("몬스터생존확인됨",2)
	}
	else if (addr != 0x005420AC)
	{
		gui,listview,몬스터리스트
		LV_delete(temp_i)
		temp_i -= 1
	}
	else if (업데이트_카운트 < 0 && 분류 != "NPC" && 분류 != "고용상인")
	{
		gui,listview,몬스터리스트
		LV_delete(temp_i)
		temp_i -= 1
...
if (몬스터리스트갯수 > 0 && 몬스터리스트선택 = 0)
{
	...
	Loop, %몬스터리스트갯수%
	{
		...
		몬스터찾음 := 0
		if (distanceX < 16 && distanceY < 7 && distanceX + distanceY != 0 && 새거리 < 거리 && 종류 = "몬스터" ) && !(종류 = "" || 새거리 = "" || 몬스터이름 = "" || 몬스터OID = "" || 타겟_X = "" || 타겟_Y = "")
		{
			if (원하는몬스터리스트갯수 > 0)
			{
				몬스터찾음 := 0
	...
	if (몬스터리스트선택 != 0 && 몬스터리스트현재선택 = 0)
	{
		...
		if (종류1 = "몬스터")
		{
			;SB_SetText("새몬스터-C1",1)
			LV_Modify(0,"-Select")
			LV_Modify(몬스터리스트선택, "Select")
		}
	}
}
;GuiControl, +Redraw, 몬스터리스트
;GuiControl, +Redraw, 신규몬스터리스트

;}

;{ ;플레이어검색
;GuiControl, -Redraw, 플레이어리스트
;GuiControl, -Redraw, 신규플레이어리스트
startAddress := 0x00590B44
endAddress := 0x00590B80
Loop {
	; 현재 주소에서 4바이트 데이터 읽기
...
loop % LV_GetCount()
{
	LV_GetText(기존_주소, temp_i, 10)
	addr := mem.read(기존_주소, "UInt", aOffsets*)
	if (addr = 0x0053E38C)
	{
		;SB_SetText("몬스터생존확인됨",2)
	}
	else if (addr != 0x0053E38C)
	{
		gui,listview,플레이어리스트
		LV_delete(temp_i)
		temp_i -= 1
...
;LV_DELETE()
;GuiControl, -Redraw, 아이템리스트
;GuiControl, -Redraw, 신규아이템리스트
...
else
{
	...
	loop % LV_GetCount()
	{
		...
		if (기존_카운트 < 0 && distanceX < 16 && distanceY < 9)
		{
			...
			업데이트_카운트 := 기존_카운트 - 1
			gui,listview,아이템리스트
			LV_Modify(A_Index,"Col11", 업데이트_카운트)
		}
	}
}
...
for index, result in itemList
{
	...
	else if ( 맵번호 = 237 || 맵번호 = 1403 || 맵번호 = 2300 ||맵번호 = 3300 || 맵번호 =  3301 || 맵번호 =  11 )
	{
    find_x := mem.read(result + 0x0C, "UInt",aOffsets*)
    find_y := mem.read(result + 0x10, "UInt",aOffsets*)
    find_z := mem.read(result + 0x14, "UInt",aOffsets*)
    ...
    loop % LV_GetCount()
    {
        ...
        if(기존_object_id = find_object_id) {
			...
			{
				gui,listview,아이템리스트
                LV_Modify(A_Index, "", "아이템", 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, result, deletedelay)
			}
            else if !NoOneOnTheItem
			{
				gui,listview,아이템리스트
                Lv_delete(A_Index)
			}
	...
	else
	{
		...
		distance := Abs(find_x - 좌표X) + Abs(find_y - 좌표Y) + Abs(find_z - 좌표Z) * 20
		...
		loop % LV_GetCount()
		{
			...
			if(기존_object_id = find_object_id)
			{
				LV_Modify(A_Index, "", "아이템", 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, result, deletedelay1, distance)
				IsNewOID := 0
				break
			}
		}
		...
		if (IsNewOID = 1)
		{
			...
			loop % LV_GetCount()
			{
				LV_GetText(원하는아이템, A_Index, 1)
				if (원하는아이템 != "" && find_name != "" && 원하는아이템 != " ")
				{
					if instr(find_name, 원하는아이템)
					{
						Error := "원하는아이템:" . 원하는아이템 . "find_name" . find_name
						writelog(Error)
						IsWantedItem := 1
						break
					}
		...
		if (IsNewOID = 1 && IsWantedItem =1 && PassBlacklisted = 1)
		{
			gui,listview,아이템리스트
			LV_Add("", "아이템", 차원, 맵이름, 맵번호, find_name, find_object_id, find_x, find_y, find_z, result,deletedelay1)
		}
	}
}
...
if (소각활성화 = 1)
{
	...
	소각딜레이 := A_tickCount - 소각_DelayCount
	if (소각딜레이 > 300 && 소각할아이템대기리스트갯수 > 0)
	{
		소각_DelayCount := A_tickCount
		LV_GetText(아이템,1,1)
		if (아이템 != "" )
		{
			소각할아이템바꾸기 := mem.writeString(0x00590147, 아이템, "UTF-16", aOffsets*) ;소각할 아이템
...
;{ ;블랙리스트 관리
	...
	if (LV_GetCount() > 2)
	{
		...
		loop % LV_GetCount()
		{
			LV_GetText(현재타겟분류, A_Index, 1)
			LV_GetText(현재타겟차원, A_Index, 2)
			LV_GetText(현재타겟맵이름, A_Index, 3)
			LV_GetText(현재타겟맵번호, A_Index, 4)
			LV_GetText(현재타겟이름, A_Index, 5)
			LV_GetText(현재타겟OID, A_Index, 6)
			LV_GetText(몬스터X, A_Index, 7)
			LV_GetText(몬스터Y, A_Index, 8)
			LV_GetText(몬스터Z, A_Index, 9)
			LV_GetText(몬스터거리, A_Index, 12)
			블랙중복 := False
			gui,listview,블랙리스트
			if (몬스터거리 != 1)
			{
			...
			if (블랙중복 = False && 몬스터거리 != 1)
			{
				...
				loop % LV_GetCount()
				{
					...
					P2Mdistance := Abs(몬스터X - 플레이어X) + Abs(몬스터Y - 플레이어Y)
					if (P2Mdistance = 1)
						P2MExist++
					if (P2MExist >= 2) ; 몹주변에 플레이어가 X명 이상있으면 바로 블랙등록, 일반사냥터는 매너겜을 위해 1 입력
					{
						gui,listview,블랙리스트
						LV_Add("",현재타겟분류,현재타겟차원,현재타겟맵이름,현재타겟맵번호,현재타겟이름,현재타겟OID,몬스터X,몬스터Y,몬스터Z,6000)
						gui,listview,몬스터리스트
						현재몬스터리스트선택 := LV_GetNext(0)
						LV_GetText(현재몬스터OID,현재몬스터리스트선택,6)
						I2Mdistance := Abs(몬스터X - 좌표X) + Abs(몬스터Y - 좌표Y)
						if (현재타겟OID = 현재몬스터OID) && ( I2Mdistance != 1)
						{
							LV_Modify(0, "-Select")
						}
						break
...
;{
	...
	if (원거리대상갯수 > 0 && 원거리선택중대상 != 0)
	{
		...
		CurrentWeapon := mem.read(0x0058DAD4, "UInt", 0x121)
		if(CurrentWeapon = 0) ; "주먹", "하프", "스태프" 번호 기록 필요
		{
			...
			for Index, spell in SpellList
			{
				...
				else if (temp_skill_usecheck == 1 && 원거리대상갯수 != 0 && CurrentWeapon = 0) && (특수원거리타겟OID != 0x0 || 특수원거리타겟OID != "")
				{
...
;{
	...
	무기번호 := 1
	무바_Coin := 1
	무기 := mem.read(0x0058DAD4, "UInt", 0x121)
	loop,
	{
		공격여부 := mem.read(0x0058DAD4, "UInt", 0x178, 0xEB)
		...
		else if (LastHit != CurrentHit)
		{
			...
			if ( NPC_TALK_DELAY > 60000 && 포레스트네자동대화 = 1 )
			{
...

{
		...
		;{ ;수리필요여부 판단
			...
			if (상승어빌 = "격투" || 상승어빌 = "도" || 상승어빌 = "검" || 상승어빌 = "단검" || 상승어빌 = "대검" || 상승어빌 = "대도" || 상승어빌 = "발굴" || 상승어빌 = "지하탐색" || 상승어빌 = "낚시")
			{
				...
				if (%상승어빌%기존어빌카운트 != 상승어빌카운트)
				{
					...
					%상승어빌%기존어빌카운트 := 상승어빌카운트
					%상승어빌%기존어빌 := 상승어빌값
					Error := %상승어빌% . "(" . Round(상승어빌값 / 100,2) . " - " . 상승어빌카운트 . "/" . 필요어빌카운트 . ") " . 올른카운트 . "카운트 상승"
					sb_settext(Error ,2)
					삼초간올린어빌카운트 += 올른카운트
				}
				if(영번어빌이름 != 상승어빌 && 일번어빌이름 != 상승어빌 && 이번어빌이름 != 상승어빌 && 삼번어빌이름 != 상승어빌)
				{
					if(상승어빌 = "격투")
					{
						영번어빌이름 := 상승어빌
						guicontrol,,영번어빌이름,%상승어빌%
					}
					else if(무기이름다음기록위치 = 1)
					{
						일번어빌이름 := 상승어빌
						guicontrol,,일번어빌이름,%상승어빌%
					}
					else if (무기이름다음기록위치 = 2)
					{
						이번어빌이름 := 상승어빌
						guicontrol,,이번어빌이름,%상승어빌%
					}
					else if (무기이름다음기록위치 = 3)
					{
						삼번어빌이름 := 상승어빌
						guicontrol,,삼번어빌이름,%상승어빌%
					}
					무기이름다음기록위치++
					if (무기이름다음기록위치 > 사용할무기수량)
					{
						무기이름다음기록위치 := 1
					}
				}
			...
			if (기존무기 != 현재무기)
			{
				기존무기 := mem.read(0x0058DAD4, "UInt", 0x121)
				sleep, 1
				if (현재무기 != 0)
				{
					if (일번무기 = 현재무기)
					...
					else if (이번무기 = 현재무기 && 사용할무기수량>=2)
					{
						이번무기수리필요 := 0
					}
					else if (삼번무기 = 현재무기 && 사용할무기수량>=3)
					{
						삼번무기수리필요 := 0
					}
					else
				...
				if (사용할무기수량 > 0)
				{
					...
					sleep, 1
					guicontrol,,삼번무기수리필요,%삼번무기수리필요%
					if(일번무기수리필요 > 20 || 이번무기수리필요 > 20 || 삼번무기수리필요 > 20)
					{
						NeedRepair := 1
						;Error := "일번무기수리필요:" . 일번무기수리필요 . " 이번무기수리필요:" . 이번무기수리필요 . " 삼번무기수리필요:" . 삼번무기수리필요
						;SB_setText("무기수리필요",1)
					}
				}
			}
	...
	if (좀비몹감지 = 0 )
	{
		/* ;
		기본적으로 좀비몹 감지는
		캐릭터가 공격을 했는데, 어빌이 안오름, 이걸 바탕으로 확인함,
		근데, 버스기사는 어빌이 100이라 어빌이 안오름, 그래서
		버스기사모드가 활성화되면 좀비몹 감시를 끔
		*/

		좀비몹감지HitCheck := mem.read(0x0058dad4,"UINT",0x1a5)
		if (좀비몹감지HitCheck != 기존좀비몹감지HitCheck)
		{
			기존좀비몹감지HitCheck := 좀비몹감지HitCheck
			Sam_InCount++
			gui,listview,몬스터리스트
			선택확인 := LV_GetNext(0)
			lv_gettext(근접체크,선택확인,12)
			IsMoving := mem.read(0x0058EB1C, "UInt", 0x174)
			...
			else if (삼초간올린어빌카운트 = 0 && 몬스터리스트좀비몹확인 != 0 && 근접체크 = 1 && Sam_InCount > 20 && IsMoving = 0)
			{
				gosub, 기본정보읽기
				gui,submit,nohide
				Sam_InCount := 0
				...
				{
					gui,listview,블랙리스트
					LV_Add("",현재타겟분류,현재타겟차원,현재타겟맵이름,현재타겟맵번호,현재타겟이름,현재타겟OID,현재타겟X,현재타겟Y,현재타겟Z,100000)
				}
			}
			else if(삼초간올린어빌카운트 != 0 && 몬스터리스트좀비몹확인 != 0 && 근접체크 = 1)
			{
				Sam_InCount := 0
				삼초간올린어빌카운트 := 0
			}
...
;{ ;
	...
	현재대화창번호 := Check_FormNumber()
	현재맵번호 := 맵번호
	현재맵이름 := mem.readString(mem.getModuleBaseAddress("jelancia_core.dll")+0x44A28, 50, "UTF-16", 0xC)
	IF (현재맵번호 != 기존맵번호)
	{
		현재대화창메시지 := Check_NPCMsg()
		Error := "기존맵번호:" . 기존맵번호 .  "기존맵이름:" . 기존맵번호 . "현재맵이름" . 현재맵번호 . "현재맵이름" . 현재맵이름
		;WriteLog(Error)
		기존맵번호 := 현재맵번호
		기존맵이름 := 현재맵이름
	}
	Else IF (현재대화창번호 != 기존대화창번호)
	{
		temp:=get_NPCTalk_cordi()
		현재창좌표X:=temp.x
		현재창좌표Y:=temp.y
		mousegetpos, 현재마우스좌표X, 현재마우스좌표Y
		차이값X := 현재마우스좌표X - 현재창좌표X
		차이값Y := 현재마우스좌표Y - 현재창좌표Y
		현재대화창메시지 := Check_NPCMsg()
		Error := "현재대화창번호: " . 현재대화창번호 . " 현재대화창메시지: " . 현재대화창메시지 . "현재창좌표X:" . 현재창좌표X . "현재창좌표Y:" . 현재창좌표Y . "현재마우스좌표X: " . 현재마우스좌표X . "현재마우스좌표Y: " . 현재마우스좌표Y . "차이값X:" . 차이값X . "차이값Y:" . 차이값Y
		;WriteLog(Error)
		기존대화창번호 := 현재대화창번호
	}
